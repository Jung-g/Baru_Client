...
using Baru_Client.Views.Pages;
using Baru_Client.Views.Windows;
using Wpf.Ui;
using Wpf.Ui.DependencyInjection;

namespace Baru_Client
{
    /// <summary>
    ...
    public partial class App
    {
        ...
        private static readonly IHost _host = Host
            ...
            .ConfigureServices((context, services) =>
            {
                ...
                services.AddSingleton<AnalysisChartPage>();        
                services.AddSingleton<AnalysisChartViewModel>();

                services.AddSingleton<ExerciseTrendPage>();       
                services.AddSingleton<ExerciseTrendViewModel>();

                services.AddSingleton<AccuracyPage>();
